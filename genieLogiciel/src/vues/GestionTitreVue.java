...
public class GestionTitreVue extends GestionGeneraleVue implements ActionListener{

	public GestionTitreVue(JFrame page){
		super(page);

		label.setText("Gestion des Titres");
		//la JList
		JPanel listePanel=new JPanel();
		listePanel.setLayout(new BorderLayout());
		JLabel tgiLabel=new JLabel("Sélection d'un Titre :");
